...
## curl -s 'http://apps.dynamide.com:7080/dynamide/ide?SESSIONID=test&noMainWindow=1&next=inspector&targetPageID=testPage&widgetID=edit1' | grep 'DEBUG:\|ERROR:'

## this works, shows the inspector for linkstrip1:
##ie.bash http://apps.dynamide.com:7080/dynamide/ide?SESSIONID=test\&noMainWindow=1\&next=inspector\&targetPageID=testPage\&widgetID=linkstrip1
